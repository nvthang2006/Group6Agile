...
@section('title', 'Quản lý Sản phẩm (Tours) - Tour Manager')

@section('page_heading', 'Sản phẩm')

@section('breadcrumb')
    <li class="breadcrumb-item active" aria-current="page">Tours / Sản phẩm</li>
@endsection
...
@section('page_css')
    ...
    <style>
        .product-img { width: 80px; height: 55px; object-fit: cover; border-radius: 6px; }
    </style>
@endsection
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
        <div class="widget-content widget-content-area br-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 mt-3">
                <h3 class="mb-0">Quản lý Tours / Sản phẩm</h3>
                ...
                <tbody>
                    @forelse($products as $product)
                        <tr>
                            ...
                            <td>
                                <span>{{ number_format($product->price) }} VNĐ</span><br>
                                @if($product->sale_price)
                                    <strong class="text-danger">Sale: {{ number_format($product->sale_price) }} VNĐ</strong>
                                @endif
                            </td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('admin.products.departures.index', $product->id) }}" class="btn btn-sm btn-success" title="Lịch khởi hành">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>
                                    </a>
                                    <form action="{{ route('admin.products.destroy', $product->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Bạn có chắc chắn muốn xóa không?')">
                                        @csrf
                                        @method('DELETE')
